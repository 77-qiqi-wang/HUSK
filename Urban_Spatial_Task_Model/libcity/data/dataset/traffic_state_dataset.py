...
class TrafficStateDataset(AbstractDataset):
    ...
    def _add_external_information_3d(self, df, ext_data=None):
        ...
        region_embeddings = np.load("../UrbanKG_Embedding_Model/embedding/NYC_region_embedding.npy")
        region_embeddings_plus = np.zeros([region_embeddings.shape[0], region_embeddings.shape[1]])
