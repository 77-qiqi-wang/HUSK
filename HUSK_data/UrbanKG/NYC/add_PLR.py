...
def main():
    # 文件路径请自行替换成实际路径
    poi_file = "/home/qwan857/UUKG_wgj/UUKG-main/UrbanKG_data/Processed_data/NYC/NYC_poi.csv"
    road_file = "/home/qwan857/UUKG_wgj/UUKG-main/UrbanKG_data/Processed_data/NYC/NYC_road.csv"
    urbanKG_file = "/home/qwan857/UUKG_wgj/UUKG-main/UrbanKG_data/UrbanKG/NYC/UrbanKG_NYC.txt"
    ...
    print("处理完成，PLR关系已追加到 UrbanKG_NYC.txt 文件中。")
